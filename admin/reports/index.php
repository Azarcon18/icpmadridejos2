        ...
        <div class="container-fluid mt-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="card-tools">
                                    <a href="?page=reports/print_report&id=<?php echo $row['id']; ?>&type=Appointment" class="btn btn-flat btn-primary" target="_blank">
            ...
            $stmt = $conn->prepare("
                ...
                FROM 
                    schedule_type st
                LEFT JOIN 
                    baptism_request br ON st.id = br.sched_type_id
                WHERE 
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <div class="card-tools">
                                    <a href="?page=reports/print_baptism&id=<?php echo $row['id']; ?>" class="btn btn-flat btn-primary" target="_blank">
            ...
            <?php
            // Close the statement for baptism requests
            $stmt->close();
            ?>
        </div>
    </div>
